...
PROJECT_ID_BASE="${GCP_TOOLS_PROJECT_NAME}-fdn"
...
echo "Dev Workload Identity Provider: projects/${PROJECT_NUMBER}/locations/global/workloadIdentityPools/${DEV_POOL_ID}/providers/${GITHUB_PROVIDER_ID}"
echo "Test Workload Identity Provider: projects/${PROJECT_NUMBER}/locations/global/workloadIdentityPools/${TEST_POOL_ID}/providers/${GITHUB_PROVIDER_ID}"
echo "Sbx Workload Identity Provider: projects/${PROJECT_NUMBER}/locations/global/workloadIdentityPools/${SBX_POOL_ID}/providers/${GITHUB_PROVIDER_ID}"
echo "Prod Workload Identity Provider: projects/${PROJECT_NUMBER}/locations/global/workloadIdentityPools/${PROD_POOL_ID}/providers/${GITHUB_PROVIDER_ID}"
