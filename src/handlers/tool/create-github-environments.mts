...
export async function createGitHubEnvironments({ repoName }: { repoName: string }) {
  ...
  return {
    ...
    message: allCreated ? 'All environments created or already exist.' : 'Some environments failed to create.',
    results,
  }
}
