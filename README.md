...
**You ask in Cursor:**
> "Create a new GCP foundation project for my app called 'my-awesome-app'"

**The MCP server will:**
- Create a new GCP project with ID like `my-awesome-app-fdn-1234567890`
...
```json
{
  "projectId": "my-awesome-app-fdn-1234567890",
  "serviceAccount": "my-awesome-app-sa@my-awesome-app-fdn-1234567890.iam.gserviceaccount.com",
  "workloadIdentityPool": "projects/123456789/locations/global/workloadIdentityPools/my-awesome-app-pool",
  "status": "success",
